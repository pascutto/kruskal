...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		\begin{frame}
			...
			\begin{tikzpicture}[>=stealth',shorten >=1pt,auto,node
				...
				\path<3,4,5,6,7,8,9,10>[draw=green] (2) edge node {3} (4);
				\path<4>[draw=red]   (2) edge node {3} (3);
				\path<5,6,7,8,9,10>[draw=green] (2) edge node {3} (3);
				\path<6,7,8,9,10>[draw=red]   (3) edge node {4} (4);
				\path<7>[draw=red]   (1) edge node {7} (2);
				\path<8,9,10>[draw=green] (1) edge node {7} (2);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		\begin{frame}
			...
			\begin{center}
				...
				\node<2,3,4,5>[draw=red,circle] (1)					{$1$};
				\node<3,4,5>[draw=red,circle] (2) [right=5cm]		{$2$};
				\node<5>[draw=red,circle] (3) [above right of=2] {$3$};
				\node<4,5>[draw=red,circle] (4) [below right of=2] {$4$};

				\path [draw=green] (2) edge node {3} (3);
				\path<1,2> [draw=green] (2) edge node {3} (4);
				\path<1,2,3> [draw]   (3) edge node {4} (4);
				\path<1> [draw=green] (1) edge node {7} (2);
				\path [draw] (1) edge node {8} (3);
				\path [draw] (1) edge node {8} (4);
				
				\path<5> [draw] (1) edge node {8} (3);
				\path<4,5> [draw]   (3) edge node {4} (4);
				\path<2,3,4,5> [draw=blue] (1) edge node {7} (2);
				\path<3,4,5> [draw=green] (2) edge node {3} (4);
